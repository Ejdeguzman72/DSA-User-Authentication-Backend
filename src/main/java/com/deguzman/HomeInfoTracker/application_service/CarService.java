...
import com.deguzman.HomeInfoTracker.application_repository.CarRepository;
import com.deguzman.HomeInfoTracker.exception.CarNotFoundException;
...
public class CarService {
	...
	{
		AutomotiveLogger.automotiveLogger.info(LoggerInfoMessage.GET_ALL_CAR_INFO_MSG);
	...
	public ResponseEntity<Car> getCarById(@PathVariable Long carid) throws CarNotFoundException, SecurityException, IOException
	{
		...
		if (carid != null)
		{
			AutomotiveLogger.automotiveLogger.info(LoggerInfoMessage.GET_CAR_INFO_BY_ID_MSG);			
		}
		else 
		{
			AutomotiveLogger.automotiveLogger.info(LoggerErrorMessage.CAR_ID_NULL_ERROR_MSG);
		}
	...
	{
		// AutomotiveLogger.automotiveLogger.info(LoggerInfoMessage.ADD_CAR_INFO_MSG + car);
	...
	public ResponseEntity<Car> updateCarInformation(@PathVariable Long carid,
			@Valid @RequestBody Car carDetails) throws CarNotFoundException, SecurityException, IOException
		{
			...
			try {
				...
				if (carid != null)
				{
					AutomotiveLogger.automotiveLogger.info(LoggerInfoMessage.UPDATE_CAR_INFO_MSG + carid);					
				}
				else
				{
					AutomotiveLogger.automotiveLogger.info(LoggerErrorMessage.CAR_ID_NULL_ERROR_MSG);
