...
import com.dsa.DeGuzmanServerApplication.exception.ContactNotFoundException;
import com.dsa.DeGuzmanServerApplication.exception.ResourceNotFoundException;
import com.dsa.DeGuzmanServerApplication.logger.ContactLogger;
...
import com.dsa.DeGuzmanServerApplication.models.Contact;
import com.dsa.DeGuzmanServerApplication.repository.ContactRepository;
...
public class ContactService {
	...
	public List<Contact> getAllContacts() throws SecurityException, IOException {
		...
		ContactLogger.log(LoggerInfoMessage.GET_ALL_CONTACT_INFO_MSG);
	...
	public ResponseEntity<Contact> getContactById(@PathVariable Long contactid) throws ContactNotFoundException, SecurityException, IOException
	 {
		if (contactid != null)
		{
			ContactLogger.log(LoggerInfoMessage.GET_CONTACT_INFO_BY_ID_MSG + contactid);		
		}
		else 
		{
			ContactLogger.log(LoggerErrorMessage.CONTACT_ID_NULL_ERROR_MSG);
		}
	...
	public Contact createContact(@Valid @RequestBody Contact contact) throws SecurityException, IOException {
		...
		ContactLogger.log(LoggerInfoMessage.ADD_CONTACT_INFO_MSG + contact);
	...
	public ResponseEntity<Contact> updateContact(@PathVariable Long contactid, 
		...
		if (contactid != null)
		{
			ContactLogger.log(LoggerInfoMessage.UPDATE_CONTACT_INFO_MSG + contactid);			
		}
		else 
		{
			ContactLogger.log(LoggerErrorMessage.CONTACT_ID_NULL_ERROR_MSG);
	...
	public Map<String, Boolean> deleteContact(@PathVariable Long contactid) throws ResourceNotFoundException, SecurityException, IOException {
		...
		if (contactid != null)
		{
			ContactLogger.log(LoggerInfoMessage.DELETE_CONTACT_INFO_MSG + contactid);			
		}
		else 
		{
			ContactLogger.log(LoggerErrorMessage.CONTACT_ID_NULL_ERROR_MSG);
