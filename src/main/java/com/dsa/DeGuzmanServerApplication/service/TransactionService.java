...
import com.dsa.DeGuzmanServerApplication.exception.TransactionNotFoundException;
...
import com.dsa.DeGuzmanServerApplication.repository.TransactionRepository;
...
public class TransactionService {
	...
	public List<Transaction> getAllTransactions() throws SecurityException, IOException {
		FinancialLogger.log(LoggerInfoMessage.GET_ALL_TRANSACTION_INFO_MSG);
	...
	public ResponseEntity<Transaction> getTransactionById(@PathVariable Long transactionid) throws TransactionNotFoundException, SecurityException, IOException
	{
		...
		{
			FinancialLogger.log(LoggerInfoMessage.GET_TRANSACTION_INFO_BY_ID_MSG);			
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.TRANSACTION_ID_NULL_ERROR_MSG);
		}
	...
	{
		FinancialLogger.log(LoggerInfoMessage.ADD_TRANSACTION_INFO_MSG + transaction);
	...
	public ResponseEntity<Transaction> updateTransaction(@PathVariable Long transactionid, @Valid @RequestBody Transaction transactionDetails) throws TransactionNotFoundException, SecurityException, IOException 
	{
		...
		if (transactionid != null)
		{
			FinancialLogger.log(LoggerInfoMessage.UPDATE_TRANSACTION_INFO_MSG + transactionid);			
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.TRANSACTION_ID_NULL_ERROR_MSG);
	...
	public Map<String, Boolean> deleteTransaction(@PathVariable Long transactionid) throws ResourceNotFoundException, SecurityException, IOException 
	{
		if (transactionid != null)
		{
			FinancialLogger.log(LoggerInfoMessage.DELETE_TRANASACTION_INFO_MSG + transactionid);			
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.TRANSACTION_ID_NULL_ERROR_MSG);
