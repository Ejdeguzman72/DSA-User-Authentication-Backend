...
public class CardService {
	...
	public List<Card> getAllCardInformation() throws SecurityException, IOException {
		FinancialLogger.log(LoggerInfoMessage.GET_ALL_CARD_INFO_MSG);
	...
	public ResponseEntity<Card> getCardById(@PathVariable Long cardid) throws CardNotFoundException, SecurityException, IOException
	{
		...
		if (cardid != null)
		{			
			FinancialLogger.log(LoggerInfoMessage.GET_CARD_INFO_BY_ID_MSG + cardid);
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.CARD_ID_NULL_ERROR_MSG);
		}
	...
	{
		FinancialLogger.log(LoggerInfoMessage.ADD_CARD_INFO_MSG + card);
			...
			@Valid @RequestBody Card cardDetails) throws SecurityException, IOException
	{
		...
		if (cardid != null)
		{
			FinancialLogger.log(LoggerInfoMessage.UPDATE_CARD_INFO_MSG + cardid);
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.CARD_ID_NULL_ERROR_MSG);
	...
	public Map<String, Boolean> deleteCard(@PathVariable Long cardid) throws SecurityException, IOException 
	{
		...
		if (cardid != null)
		{
			FinancialLogger.log(LoggerInfoMessage.DELETE_CARD_INFO_MSG + cardid);
		}
		else 
		{
			FinancialLogger.log(LoggerErrorMessage.CARD_ID_NULL_ERROR_MSG);
