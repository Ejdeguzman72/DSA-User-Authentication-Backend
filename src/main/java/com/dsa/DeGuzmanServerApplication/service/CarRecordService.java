...
public class CarRecordService {
	...
	{
		AutomotiveLogger.log(LoggerInfoMessage.GET_ALL_CAR_RECORD_INFO_MSG);
	...
	public ResponseEntity<CarRecord> getCarRecordById(@PathVariable Long carRecordId) throws CarRecordNotFoundException, SecurityException, IOException
	{
		...
		if (carRecordId != null)
		{
			AutomotiveLogger.log(LoggerInfoMessage.GET_ALL_CAR_RECORD_INFO_MSG + carRecordId);			
		}
		else 
		{
			AutomotiveLogger.log(LoggerErrorMessage.CAR_RECORD_ID_NULL_ERROR_MSG);
		}
	...
	{
		AutomotiveLogger.log(LoggerInfoMessage.ADD_CAR_RECORD_INFO_MSG + carRecord);
			...
			@Valid @RequestBody CarRecord carRecordDetails) throws CarRecordNotFoundException, SecurityException, IOException
	{
		...
		try {
			...
			if (carRecordId != null)
			{
				AutomotiveLogger.log(LoggerInfoMessage.UPDATE_CAR_RECORD_INFO_MSG + carRecordId);
			}
			else 
			{
				AutomotiveLogger.log(LoggerErrorMessage.CAR_RECORD_ID_NULL_ERROR_MSG);
	...
	public Map<String, Boolean> deleteCarRecord(@PathVariable Long carRecordId) throws CarRecordNotFoundException, SecurityException, IOException
	{
		...
		if (carRecordId != null)
		{
			AutomotiveLogger.log(LoggerInfoMessage.DELETE_CAR_RECORD_INFO_MSG + carRecordId);			
		}
		else 
		{
			AutomotiveLogger.log(LoggerErrorMessage.CAR_RECORD_ID_NULL_ERROR_MSG);
