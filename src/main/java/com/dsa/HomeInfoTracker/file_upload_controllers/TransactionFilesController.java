...
import com.dsa.HomeInfoTracker.file_upload_models.AutoTransactionFileInfo;
import com.dsa.HomeInfoTracker.file_upload_service.AutoTransactionFilesStorageService;
	...
	public ResponseEntity<List<AutoTransactionFileInfo>> getListFiles() {
		List<AutoTransactionFileInfo> autoTrxFileInfos = (List<AutoTransactionFileInfo>) autoTrxFilesStorageService.loadAllAutoFiles().map(path -> {
			...
			String url = MvcUriComponentsBuilder
					.fromMethodName(TransactionFilesController.class, "getAutoFile",path.getFileName().toString()).build().toString();
